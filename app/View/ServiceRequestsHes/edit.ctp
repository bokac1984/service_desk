...
<?php echo $this->Form->create('ServiceRequestsH'); ?>
	<fieldset>
		<legend><?php echo __('Edit Service Requests H'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ServiceRequestsH.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ServiceRequestsH.id'))); ?></li>
