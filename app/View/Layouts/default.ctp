                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><?php echo $this->Html->link('Dodaj dokument', array('prefix' => null, 'plugin' => null, 'controller' => 'direktorijums', 'action' => 'add')); ?></li>
                                <li class="divider"></li>
                                <li><?php echo $this->Html->link('Pregled', array('prefix' => null, 'plugin' => null, 'controller' => 'direktorijums', 'action' => 'index')); ?></li>
                            </ul>
                        </li>
                        <li class="dropdown">
