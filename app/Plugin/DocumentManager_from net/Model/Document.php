...
class Document extends DocumentManagerAppModel {
    ...
    function saveDocument($data, $pathFolderNames = array(), $userId, $headers = array()) {
        ...
        } else if (empty($data['file']['error']) && !empty($data['file']['tmp_name']) && $data['file']['tmp_name'] != 'none' && is_uploaded_file($data['file']['tmp_name'])) {
     ...
     */
    public static function getRelativePath($pathFolderNames = array(), $fileName = '') {
